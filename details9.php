...
<body>
    <div id="working">
        <div class="row2">
            <div class="col22">
                <img src="Labour.jpg">
                <h4 class="p-name">Labour</h4>
                <p class="p-price">₹ 500 /Day<p>
                <p class="p-detail">DoEasy.com offers labours who are well experienced in their work. They will be available with their proper equipments. So What's stopping you. <b>Hire Now!</b></p>
            </div>
            <div class="col1"> 
                <div class="container">
                    ...
                    <div class="content">
                      <form action="/Web Development Project/details9.php" method="POST">
                        <div class="user-details">
                          ...
                          <div class="input-box">
                            <span class="details">Number of Labours</span>
                            <input type="number" placeholder="Enter Number of Labours" name="worker" required>
                          </div>
                          <div class="input-box">
