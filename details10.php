...
<body>
    <div id="working">
        <div class="row2">
            <div class="col22">
                <img src="painter.jpg">
                <h4 class="p-name">Painter</h4>
                <p class="p-price">₹ 500 /Day</p>
                <p class="p-detail">DoEasy.com offers painters who are well experienced in their work. They will be available with their proper equipments. So What's stopping you. <b>Hire Now!</b></p>
            </div>
            <div class="col1"> 
                <div class="container">
                    ...
                    <div class="content">
                      <form action="/Web Development Project/details10.php" method="POST">
                        <div class="user-details">
                          ...
                          <div class="input-box">
                            <span class="details">Number of Painters</span>
                            <input type="number" placeholder="Enter Number of Painters" name="worker" required>
                          </div>
                          <div class="input-box">
