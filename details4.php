...
<body>
    <div id="working">
        <div class="row2">
            <div class="col22">
                <img src="gardener.jpg">
                <h4 class="p-name">Gardener</h4>
                <p class="p-price">₹ 250 /Day<p>
                <p class="p-detail">DoEasy.com offers gardeners who are well experienced in their work. They will be available with their proper equipments. So What's stopping you. <b>Hire Now!</b></p>
            </div>
            <div class="col1"> 
                <div class="container">
                    ...
                    <div class="content">
                      <form action="/Web Development Project/details4.php" method="POST">
                        <div class="user-details">
                          ...
                          <div class="input-box">
                            <span class="details">Number of Gardeners</span>
                            <input type="number" placeholder="Enter Number of Gardeners" name="worker" required>
                          </div>
                          <div class="input-box">
