...
<body>
    <div id="working">
        <div class="row2">
            <div class="col22">
                <img src="courier.jpg">
                <h4 class="p-name">Courier Person</h4>
                <p class="p-price">₹ 200 (For once)</p>
                <p class="p-detail">DoEasy.com offers courier persons who are well experienced in their work. They will be available with their proper equipments. So What's stopping you. <b>Hire Now!</b></p>
            </div>
            <div class="col1"> 
                <div class="container">
                    ...
                    <div class="content">
                      <form action="/Web Development Project/details14.php" method="POST">
                        <div class="user-details">
                          ...
                          <div class="input-box">
                            <span class="details">Number of Courier Persons</span>
                            <input type="number" placeholder="Enter Number of Courier Persons" name="worker" required>
                          </div>
                          <div class="input-box">
