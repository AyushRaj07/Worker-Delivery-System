...
<body>
    <div id="working">
        <div class="row2">
            <div class="col22">
                <img src="Agrilabour.jpg">
                <h4 class="p-name">Agricultural Labour</h4>
                <p class="p-price">₹ 400 /Day</p>
                <p class="p-detail">DoEasy.com offers agricultural Labour who are well experienced in their work. They will be available with their proper equipments. So What's stopping you. <b>Hire Now!</b></p>
            </div>
            <div class="col1"> 
                <div class="container">
                    ...
                    <div class="content">
                      <form action="/Web Development Project/details11.php" method="POST">
                        <div class="user-details">
                          ...
                          <div class="input-box">
                            <span class="details">Number of Agricultural Labours</span>
                            <input type="number" placeholder="Enter Number of Agricultural Labours" name="worker" required>
                          </div>
                          <div class="input-box">
