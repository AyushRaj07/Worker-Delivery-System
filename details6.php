    ...
    <div id="working">
        <div class="row2">
            <div class="col22">
                ...
                <h4 class="p-name">Mechanic</h4>
                <p class="p-price">₹ 500 (Min. Price)</p>
                <p class="p-detail">DoEasy.com offers mechanics who are well experienced in their work. They will be available with their proper equipments. So What's stopping you. <b>Hire Now!</b></p>
            </div>
            <div class="col1"> 
                <div class="container">
                    ...
                    <div class="content">
                      <form action="/Web Development Project/details6.php" method="POST">
                        <div class="user-details">
                          ...
                          <div class="input-box">
                            <span class="details">Number of Mechanics</span>
                            <input type="number" placeholder="Enter Number of Mechanics" name="worker" required>
                          </div>
                          <div class="input-box">
